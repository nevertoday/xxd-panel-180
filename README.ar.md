...
# XXD Panel 180｜ختم سفر دائري بطابع عتيق
...
ختم تذكاري دائري صغير يجمع الموضوع الأساسي مع عنصر أو عنصرين من البيئة. خطوط حفر خشبي ومطاطي ونقش دقيق على ورق عاجي معتّق، مع حبر متفاوت وطبعات ناقصة وانزياح طفيف. لونان أو ثلاثة مستمدّة من الصورة كأحبار باهتة، ولمسات ذهبية ضئيلة، وفراغ واسع وعنوان إنجليزي وكلمات مفتاحية أصغر أسفل الختم.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 180 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-180`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-180 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-180-prompt.en.md) أو [بالصينية](references/xxd-panel-180-prompt.zh-CN.md).
